...
function GlobeDemo() {
  ...
  const lightThemeColors = {
    ...
    emissive: "#cce4ff", // Light Blue
    polygonColor: "rgba(0, 0, 0, 0.9)", // Darker Gray
    ambientLight: "#a1c4fd", // Light Blue
    directionalLeftLight: "#ffffff", // White
    directionalTopLight: "#ffffff", // White
    pointLight: "#ffffff", // White
    colors : ["#0c2d6b", "#1e3a87", "#2e3f75"]
  ...
  const sampleArcs = [
    {
      ...
      endLng: -43.1729,
      arcAlt: 0.1,
      color: globeConfig.colors[Math.floor(Math.random() * (globeConfig.colors.length - 1))],
    },
    {
      order: 1,
      startLat: 28.6139,
